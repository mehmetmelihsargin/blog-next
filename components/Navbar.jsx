      ...
      <div class="py-6 mx-auto max-w-7xl md:flex-row">
        <div class="flex flex-col flex-wrap items-center py-5 border-t border-b border-gray-200 md:flex-row">
          <nav class="flex flex-wrap items-center text-base lg:w-2/5 md:ml-auto">
            <a
              href="/"
              class="mr-5 font-semibold leading-6 text-gray-500 hover:text-gray-600"
            >
              Home
            </a>
          ...
          <a
            href="#_"
            class="flex items-center order-first mb-4 font-medium text-gray-800 lg:order-none lg:w-1/5 title-font lg:items-center lg:justify-center md:mb-0"
          >
